...
class FlowerClient(NumPyClient):
    ...
    def fit(self, parameters, config):
        ...
        train_results_folder = f"{self.client_name}_round{self.rounds}_train_results"
    ...
    def evaluate(self, parameters, config):
        ...
        val_results_folder = f"{self.client_name}_round{self.rounds}_val_results"
...
def server_update():
    ...
    global is_training_flag, flag, num_clients 
